...
// T19.1 — /concerns route wires DateRangeChips — RETIRED by ADR-0027
// Phase 2a PR2: live /concerns no longer ships URL-state multi-axis filtering
// (Decision 8 future scope). Post-cutover contract is pinned by
