...
export const COPY_KEYS = Object.freeze([
  ...
  'onboarding.browser_baseline_d2.ua_baseline_below_supported',
  ...
  'onboarding.passphrase_d4.confirm_aria_label',
  'onboarding.passphrase_d4.confirm_continue_button',
  ...
  'onboarding.panic_wipe_d6.type_back_aria_label',
